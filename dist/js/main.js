...
/* harmony export */   gheInitLenisCinematic: () => (/* binding */ gheInitLenisCinematic),
/* harmony export */   initTravelBannerParallax: () => (/* binding */ initTravelBannerParallax)
/* harmony export */ });
...
var gheEaseExpoOut = function gheEaseExpoOut(t) {
  return t === 1 ? 1 : 1 - Math.pow(2, -10 * t);
};
var gheLenis;
var tickerCallback;
function gheInitLenisCinematic() {
  if (gheLenis) return gheLenis;
  var reduceMotion = window.matchMedia && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
  gheLenis = new lenis__WEBPACK_IMPORTED_MODULE_2__["default"]({
    duration: reduceMotion ? 0 : 1.35,
    easing: reduceMotion ? function (t) {
      return t;
    } : gheEaseExpoOut,
  ...
  gheLenis.on("scroll", gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.update);
  tickerCallback = function tickerCallback(time) {
    return gheLenis.raf(time * 1000);
  };
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.ticker.add(tickerCallback);
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.addEventListener("refresh", function () {
    return gheLenis.resize();
  });
  return gheLenis;
}
function initTravelBannerParallax() {
  var el = document.querySelector("#section-travel-banner");
  if (!el) return;
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(el, {
    ...
    // more reliable than full backgroundPosition string
    ease: "none",
    scrollTrigger: {
      trigger: el,
      start: "top bottom",
...
window.addEventListener("load", function () {
  return gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.refresh();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap */ "./assets/js/gsap.js");
/* harmony import */ var _stickyHeader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stickyHeader */ "./assets/js/stickyHeader.js");
/* harmony import */ var _stickyHeader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_stickyHeader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _megaMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./megaMenu */ "./assets/js/megaMenu.js");
...
function initMegaMenu() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    lenis = _ref.lenis;
  var openBtn = document.querySelector(".mega-menu-button-open");
  var closeBtn = document.querySelector(".mega-menu-button-close");
  var mega = document.querySelector(".mega-menu-wrapper");
  if (!openBtn || !closeBtn || !mega) return;
  var panelLeft = mega.querySelector(".mega-panel--left");
  var panelRight = mega.querySelector(".mega-panel--right");
  var animatedEls = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(mega.querySelectorAll(".mega-menu-button-close, ul.mega-menu > li.menu-item, .mega-menu-language-switcher"));
  ...
  var setInert = function setInert(el, value) {
    if ("inert" in el) el.inert = value;
  };
  var getFocusable = function getFocusable(root) {
    return Array.from(root.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(function (el) {
      return !el.hasAttribute("disabled") && !el.getAttribute("aria-hidden");
    });
  };
  var focusFirstInMega = function focusFirstInMega() {
    var _focus, _ref2;
    var focusables = getFocusable(mega);
    (_focus = (_ref2 = focusables[0] || closeBtn || mega).focus) === null || _focus === void 0 || _focus.call(_ref2, {
      preventScroll: true
    });
  };
  ...
  // open/close setup
  // ---------------------------
  var isPanelRightHidden = function isPanelRightHidden() {
    if (!panelRight) return true;
    var styles = window.getComputedStyle(panelRight);
    return styles.display === "none";
  };
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(mega, {
    autoAlpha: 0,
    pointerEvents: "none",
    xPercent: -100
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(panelLeft, {
    x: -200
  });
  if (panelRight && !isPanelRightHidden()) gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(panelRight, {
    xPercent: -120
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(animatedEls, {
    x: -12,
    autoAlpha: 0
  });
  setInert(mega, true);
  ...
  // ---------------------------
  var drilldown = initMegaMenuDrilldown({
    mega: mega,
  ...
  var setOpenState = function setOpenState(nextOpen) {
    isOpen = nextOpen;
  ...
  document.addEventListener("keydown", function (e) {
    ...
    if (e.key === "Escape") {
      e.preventDefault();
      if (drilldown.isSubmenuOpen()) drilldown.back(false);else close();
      return;
    }
    if (e.key === "Tab") {
      var focusables = getFocusable(mega);
  ...
  tl.eventCallback("onReverseComplete", function () {
    ...
    if (lastFocusedEl && typeof lastFocusedEl.focus === "function") {
      ...
      var _openBtn$focus;
      (_openBtn$focus = openBtn.focus) === null || _openBtn$focus === void 0 || _openBtn$focus.call(openBtn, {
        preventScroll: true
      });
    }
  });
...
function initMegaMenuDrilldown() {
  var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    mega = _ref3.mega,
    _ref3$stageSelector = _ref3.stageSelector,
    stageSelector = _ref3$stageSelector === void 0 ? ".mega-panel--left nav" : _ref3$stageSelector,
    _ref3$mainMenuSelecto = _ref3.mainMenuSelector,
    mainMenuSelector = _ref3$mainMenuSelecto === void 0 ? "ul.mega-menu" : _ref3$mainMenuSelecto,
    _ref3$submenuSelector = _ref3.submenuSelector,
    submenuSelector = _ref3$submenuSelector === void 0 ? "ul.sub-menu" : _ref3$submenuSelector,
    _ref3$backSelector = _ref3.backSelector,
    backSelector = _ref3$backSelector === void 0 ? ".submenu-back" : _ref3$backSelector;
  var stage = mega.querySelector(stageSelector);
  if (!stage) return noopDrilldown();
  var mainUl = stage.querySelector(mainMenuSelector);
  if (!mainUl) return noopDrilldown();

  // Ensure stage is a positioning context
  var computedPos = window.getComputedStyle(stage).position;
  if (computedPos === "static") stage.style.position = "relative";
  var prefersReduced = window.matchMedia("(prefers-reduced-motion: reduce)").matches;
  var dur = prefersReduced ? 0 : 0.65;
  ...
  var panelsByKey = new Map();
  var topLis = Array.from(mainUl.children).filter(function (el) {
    return el.tagName === "LI";
  });
  topLis.forEach(function (li, index) {
    // Find direct child submenu without using :scope
    var submenu = Array.from(li.children).find(function (el) {
      return el.tagName === "UL" && el.classList.contains("sub-menu");
    });
    if (!submenu) return;

    // Stable key (WP provides li.id like "menu-item-52")
    var key = li.id || li.getAttribute("data-drilldown-key") || "drilldown-".concat(index);
  ...
  var setSubtreeEnabled = function setSubtreeEnabled(root, enabled) {
    if (!root) return;
    if ("inert" in root) {
      root.inert = !enabled;
    ...
    root.setAttribute("aria-hidden", String(!enabled));
    var focusables = root.querySelectorAll('a[href], button, input, select, textarea, [tabindex]');
    focusables.forEach(function (el) {
      if (!enabled) {
        ...
        var _orig = el.getAttribute("data-orig-tabindex");
        if (_orig !== null) {
          el.removeAttribute("data-orig-tabindex");
          if (_orig === "") el.removeAttribute("tabindex");else el.setAttribute("tabindex", _orig);
        } else {
  ...
  var focusFirstIn = function focusFirstIn(root) {
    var _el$focus;
    var el = root.querySelector('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])');
    el === null || el === void 0 || (_el$focus = el.focus) === null || _el$focus === void 0 || _el$focus.call(el, {
      preventScroll: true
    });
  };

  // Initial states
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(mainWrap, {
    xPercent: 0,
    autoAlpha: 1,
    pointerEvents: "auto"
  });
  setSubtreeEnabled(mainWrap, true);
  panelsByKey.forEach(function (panel) {
  ...
  var openPanel = function openPanel(key, triggerEl) {
    if (animating || activePanel) return;
    var panel = panelsByKey.get(key);
    if (!panel) return;
    animating = true;
    activePanel = panel;
    activeKey = key;
  ...
  var back = function back() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
      ...
      onComplete: function onComplete() {
        ...
        activeKey = null;
        animating = false;
        if (typeof onDone === "function") onDone();else if ((_lastTrigger = lastTrigger) !== null && _lastTrigger !== void 0 && _lastTrigger.focus) lastTrigger.focus({
          preventScroll: true
        });
      }
    }).to(panel, {
  ...
  var reset = function reset() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf([mainWrap].concat(_toConsumableArray(panelsByKey.values())));
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(mainWrap, {
      xPercent: 0,
      autoAlpha: 1,
      pointerEvents: "auto"
  ...
  stage.addEventListener("click", function (e) {
    ...
    var key = li.id || li.getAttribute("data-drilldown-key");
  ...
  stage.addEventListener("keydown", function (e) {
    ...
    var isActivateKey = e.key === "Enter" || e.key === " ";
    if (!isActivateKey) return;
    var link = (_e$target$closest = (_e$target = e.target).closest) === null || _e$target$closest === void 0 ? void 0 : _e$target$closest.call(_e$target, "a");
    if (!link) return;
    var li = link.closest("li");
    if (!li || li.parentElement !== mainUl) return;
    var key = li.id || li.getAttribute("data-drilldown-key");
...
window.addEventListener("load", function () {
  if (document.querySelector(".single-zimmer") || document.querySelector(".single-suiten")) {
    var thumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-thumbs-swiper', {
      slidesPerView: 'auto',
      spaceBetween: 14,
      watchSlidesProgress: true
    });
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-images-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      effect: 'slide',
...
document.addEventListener("DOMContentLoaded", function () {
  var el = document.querySelector("#testimonials-section .testimonials-swiper");
  if (!el) return;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgrand_hotel_europe"] = self["webpackChunkgrand_hotel_europe"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/main","css/admin-login"], () => (__webpack_require__("./assets/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/main","css/admin-login"], () => (__webpack_require__("./assets/sass/main.sass")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/main","css/admin-login"], () => (__webpack_require__("./assets/sass/admin-login.sass")))

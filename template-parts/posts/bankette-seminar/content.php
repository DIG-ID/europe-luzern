<?php
/**
 * Content Section in the Bankette and Seminar Single Posts Template.
 *
...
<section id="bankette-seminar-content" class="bankette-seminar-content relative overflow-hidden">
  <div class="theme-container">
    <div class="theme-grid pt-20 md:pt-24 xl:pt-16 pb-20 xl:pb-36">
      ...
      <div class="col-span-2 md:col-span-6 xl:col-span-4 xl:col-start-9">
          <div class="bankette-seminar-sidebar bg-cream px-5 md:px-5 xl:px-16 py-5 md:py-9 xl:pt-12 xl:pb-16">
    ...
    <div class="theme-grid pt-10 md:pt-12 xl:pt-24">
      <div class="col-span-2 md:col-span-6 xl:col-span-12 theme-grid relative">
        <?php get_template_part( 'template-parts/posts/bankette-seminar/gallery' ); ?>
      </div>
    </div>
  </div>
</section>
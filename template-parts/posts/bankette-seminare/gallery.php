...
?>
  ...
  <!-- Nav arrows -->
  <div class="bankette-seminare-nav-arrows col-span-2 md:col-span-6 xl:col-span-12 absolute w-full bottom-5 left-0 -translate-y-1/2 z-10">
    <button type="button" class="swiper-button-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 flex items-center justify-center">
    ...
    <button type="button" class="swiper-button-next absolute right-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 flex items-center justify-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
  ...
  <!-- Thumbs -->
  <div class="gallery-images-swiper-col relative col-span-2 md:col-span-4 xl:col-span-10 col-start-1 md:col-start-2 xl:col-start-2">
    <div class="swiper gallery-thumbs-swiper-bs mt-4">
      <div class="swiper-wrapper">
        ...
        ?>
          <div class="swiper-slide !w-36 !h-20 cursor-pointer opacity-50 transition-opacity duration-300" data-index="<?php echo esc_attr($i); ?>">

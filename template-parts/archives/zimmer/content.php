      ...
      <?php if ( have_posts() ) : ?>
        ...
        <?php while ( have_posts() ) : the_post(); $i++; ?>
          <?php
            ...
            $border_side = $is_even ? 'zimmer-border--right' : 'zimmer-border--left';
          ?>
          <article class="col-span-2 md:col-span-6 xl:col-span-12">
            <div class="relative zimmer-border <?php echo esc_attr($border_side); ?> pt-0 pb-32 <?php echo esc_attr($section_padding); ?>">

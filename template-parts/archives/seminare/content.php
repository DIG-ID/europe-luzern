<?php
/**
 * Content Section in the seminare Archive Template.
 *
 * Loop trough Custom Post Type seminare.
 *
  ...
  <div class="theme-container">
    <div class="theme-grid">
      <div class="col-span-2 md:col-span-4 xl:col-span-6">
        <h2 class="title-secondary text-dark-2 mb-20"><?php the_field('seminare_content_bankette_title', 'option'); ?></h2>
      </div>
    </div>
  </div>
  <div class="theme-container">
    <div class="theme-grid">
      ...
      <?php if ( $bankette_query->have_posts() ) : ?>
        <?php $i = 0; ?>
        <?php while ( $bankette_query->have_posts() ) : $bankette_query->the_post(); $i++; ?>
          <?php
            $is_even = ($i % 2 === 0);
            $image_order     = $is_even ? 'xl:order-2' : 'xl:order-1';
            $content_order   = $is_even ? 'xl:order-1' : 'xl:order-2';
    ...
    <div class="theme-grid">
        <div class="col-span-2 md:col-span-6 xl:col-span-12 theme-grid">
          <div class="col-span-2 md:col-span-3 xl:col-span-5">
            <h2 class="title-secondary text-dark-2 mb-5 md:mb-0"><?php the_field('seminare_content_bottom_title', 'option'); ?></h2>
          </div>

            ...
            <?php if (have_rows('repeater')) : ?>
              ...
              ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-6 xl:grid-cols-12 xl:grid-rows-2 gap-x-5 xl:gap-x-7 gap-y-6 md:gap-y-8">
                  ...
                  <div class="col-span-2 md:col-span-3 xl:col-span-6 xl:row-span-2">
                    <div class="">
                      <?php if ($title) : ?><h3 class="title-small text-darker md:!text-[26px] xl:!text-[36px]"><?php echo esc_html($title); ?></h3>
                      <?php endif; ?>
                    </div>
                    <div class="pt-5">
                        <?php if ($text) : ?><p class="body text-darker max-w-[527px]"><?php echo esc_html($text); ?></p>
                      <?php endif; ?>
                    </div>

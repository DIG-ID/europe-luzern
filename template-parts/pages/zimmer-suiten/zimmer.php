<section id="section-zimmer" class="section-zimmer relative overflow-hidden pb-10">
    <div class="theme-container pt-8 bg-[linear-gradient(to_bottom,#F8F5F0_0%,#F8F5F0_75%,#FFFFFF_75%,#FFFFFF_100%)] md:bg-[linear-gradient(to_bottom,#F8F5F0_0%,#F8F5F0_65%,#FFFFFF_65%,#FFFFFF_100%)]">
      <div class="theme-grid">
        <div class="col-span-2 md:col-span-3 xl:col-span-6 xl:col-start-2">
          <p class="overtitle text-dark-2 mb-4"><?php the_field( 'zimmer_overtitle' ); ?></p>
          <h2 class="title-secondary text-dark-2"><?php the_field( 'zimmer_title' ); ?></h2>
        ...
        <div class="col-span-2 md:col-span-3 xl:col-span-5">
          <figure class="framed__symmetric--bottom-left w-full">
            ...
            if ( $zimmer_id ) :
              echo wp_get_attachment_image( $zimmer_id, 'full', false, array( 'class' => 'w-full h-full object-cover' ) );
            endif;
            ?>
          </figure>
        </div>
